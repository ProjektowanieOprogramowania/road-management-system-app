...
export const TollsMock: PassingChargeModel[] = [
  ...
  //   charge: ChargesMock.find(x => x.id === 1)!
  // },
  // {
  //   id: 2,
  //   passing: PassingsMock.find(x => x.id === 2)!,
  //   charge: ChargesMock.find(x => x.id === 2)!
  // },
  // {
  //   id: 3,
  //   passing: PassingsMock.find(x => x.id === 3)!,
  //   charge: ChargesMock.find(x => x.id === 3)!
  // },
  // {
  //   id: 4,
  //   passing: PassingsMock.find(x => x.id === 1)!,
